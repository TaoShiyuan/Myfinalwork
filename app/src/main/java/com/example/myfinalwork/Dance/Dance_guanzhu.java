...
public class Dance_guanzhu extends AppCompatActivity {
    private DBHelper dbHelper;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dance_guanzhu);
        //创建个人信息数据库
        ...
        fanhui.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Dance_guanzhu.this, MainActivity.class);
        ...
        btn_chengyuan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Dance_guanzhu.this, Dance_chengyuanzongji.class);
                startActivity(intent);
            }
        });
    }
